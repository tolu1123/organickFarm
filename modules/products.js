...
function productTemplate(product, root, redirectBoolean, updateShopPage, container) {
    ...
    template.innerHTML = `
                    ...
                    <div class="productFirstElem w-full inline-flex flex-col transitions sm:group-hover:w-[170px] sm:pr-[10px]">
                        ...
                        <button class="-translate-y-6 -mb-6 sm:translate-y-0 transitions opacity-0 sm:group-hover:opacity-100  sm:group-hover:z-[1015] bg-deepGreen p-1 rounded-md text-white text-sm">Go to Cart</button>
                    </div>
